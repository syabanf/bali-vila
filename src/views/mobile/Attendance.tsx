  ...
  return (
    <div className="min-h-screen bg-sand-50 pb-24">
      ...
      <div className="px-4 mt-5">
        <div className="bg-white rounded-2xl border border-sand-300 shadow-card p-5 text-center">
          <div className={clsx(
            ...
            <Clock className={clsx('w-8 h-8', clockedIn ? 'text-teal-600' : 'text-cocoa-500')} />
          </div>
          <div className="font-display text-2xl font-semibold text-cocoa-800">10:24:07</div>
          <div className="text-xs text-cocoa-500 mt-1">Current time · Monday, 12 May 2026</div>
          {clockedIn && (
      ...
      <div className="px-4 mt-4">
        <h3 className="font-semibold text-sm text-cocoa-800 mb-2">Current Location</h3>
        <div className="relative h-36 bg-gradient-to-br from-teal-50 to-navy-50 rounded-2xl border border-sand-300 overflow-hidden shadow-card">
      ...
      {/* Activity timeline */}
      <div className="px-4 mt-5">
        <h3 className="font-semibold text-sm text-cocoa-800 mb-3">Today's Activity</h3>
        <div className="relative">
          ...
          <div className="space-y-3">
            {timeline.map((event, i) => (
              <div key={i} className="flex items-start gap-3 pl-2">
                ...
                <div className="flex-1 bg-white rounded-xl p-3 border border-sand-300 shadow-card">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-cocoa-800">{event.event}</span>
                    <span className="text-xs text-cocoa-500">{event.time}</span>
                  </div>
